...
<html lang="en">
  ...
  <!-- container -->
    ...
    <!-- form -->
      <form action="new-expense-add.php" method="post" enctype="multipart/form-data">
        <div class="card-body">
        <!--row -->
          <div class="row">
          <!-- column -->
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="date" name="expense_date" class="form-control" style="width: 100%;" placeholder="00/00/0000">
                </div>
              </div>

              <div class="form-group">
                <label>Expense</label>
                <input type= "text" name="product" class="form-control" style="width: 100%;" placeholder="Enter expense">
              </div>
            <!-- /.form-group -->
          ...
          <!-- column -->
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label>Client</label>
                <select id="client" class="form-control" name="client" style="width: 100%;">
                </select>
              </div>

              <div class="form-group">
                <label>Category</label>
                <select class="form-control" name="bucket" style="width: 100%;">
              ...
              <div class="form-group">
                ...
                <input type="file" name="receipt_image" accept="image/*" class="form-control" style="width: 100%;">
              </div>
            </div>
          <!-- Column -->
          </div>
